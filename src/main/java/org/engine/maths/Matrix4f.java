...
public class Matrix4f {
	...
	public static Matrix4f multiplyV (Matrix4f matrix, Matrix4f other){
		Matrix4f result = Matrix4f.identity();

		result.set(0,0, matrix.get(0,0)*other.get(0,0)+
				matrix.get(0,1)*other.get(1,0)+
				matrix.get(0,2)*other.get(2,0)+
				matrix.get(0,3)*other.get(3,0));
		result.set(1,0, matrix.get(1,0)*other.get(0,0)+
				matrix.get(1,1)*other.get(1,0)+
				matrix.get(1,2)*other.get(2,0)+
				matrix.get(1,3)*other.get(3,0));
		result.set(2,0, matrix.get(2,0)*other.get(0,0)+
				matrix.get(2,1)*other.get(1,0)+
				matrix.get(2,2)*other.get(2,0)+
				matrix.get(2,3)*other.get(3,0));
		result.set(3,0, matrix.get(3,0)*other.get(0,0)+
				matrix.get(3,1)*other.get(1,0)+
				matrix.get(3,2)*other.get(2,0)+
				matrix.get(3,3)*other.get(3,0));
